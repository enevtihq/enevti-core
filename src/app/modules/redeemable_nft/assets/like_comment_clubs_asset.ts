...
import { LikeCommentClubsProps } from 'enevti-types/asset/redeemable_nft/like_comment_clubs_asset';
...
export class LikeCommentClubsAsset extends BaseAsset {
  ...
  public validate({ asset }: ValidateAssetContext<LikeCommentClubsProps>): void {
