...
export class EnevtiHttpApiPlugin extends BasePlugin {
  ...
  public async load(channel: BaseChannel): Promise<void> {
    ...
    this._app.get('/nft/id/:id/moment', controller.getNFTMomentById(this._channel));
    ...
    this._app.get('/like/moment/:id', controller.getMomentLike(this._channel));
    ...
    this._app.get(
      '/authorized/moment/:id',
      controller.isAddressMomentOwnerOrCreator(this._channel),
    );
